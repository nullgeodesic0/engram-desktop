 ...
 * Task 1 fix-wave report for the full table): `long-form-humanities` has
 * 1 active day (all 5 of its encodes landed on a single day) and
 * `applied-policy` has 2 — both correctly render nothing, and stay
 ...
 * (spec's evidence: `long-form-humanities` did 5 encodes on a SINGLE day,
