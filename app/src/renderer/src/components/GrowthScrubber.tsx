  ...
  return (
    ...
    >
      <button
        ...
        className="focus-ring shrink-0 w-7 h-7 flex items-center justify-center rounded-full text-[var(--color-ink-warm)] hover:text-[var(--color-text-primary)] hover:bg-[var(--color-surface-3)]"
      >
        {playing ? (
