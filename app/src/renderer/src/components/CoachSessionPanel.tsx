      ...
      <div className="flex flex-wrap gap-2">
        {QUICK_ACTIONS.map((a) => (
          <button
            ...
            disabled={busy}
            className="focus-ring px-3 py-1.5 rounded-lg text-xs bg-[color-mix(in_srgb,var(--color-surface-2)_68%,transparent)] text-[var(--color-text-dim)] hover:text-[var(--color-ink-warm)] disabled:opacity-40"
          >
            {a.label}
          </button>
        ))}
      ...
      {sessionId && (
        <div className="flex gap-2">
          <input
            ...
            disabled={busy}
            className="focus-ring flex-1 panel px-3 py-2 text-sm bg-[color-mix(in_srgb,var(--color-surface-2)_68%,transparent)] text-[var(--color-text-primary)] disabled:opacity-50"
          />
          <button
            onClick={submitInput}
            disabled={!input.trim() || busy}
            className="focus-ring px-4 py-2 rounded-lg text-sm bg-[color-mix(in_srgb,var(--color-surface-3)_68%,transparent)] text-[var(--color-ink-warm)] disabled:opacity-40"
          >
            Send
          </button>
        </div>
