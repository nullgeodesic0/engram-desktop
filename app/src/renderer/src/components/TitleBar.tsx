 ...
 *
 * `onGoHome` — a single familiar button back to the hub. Section switching
 * lives in the CommandStrip rendered just below this bar (see App.tsx) —
 * the old quick-switch chevron dropdown here was retired when the strip
 * made it redundant. Optional so this component still renders standalone
 * (e.g. a future secondary window) without wiring it. */
