...
const engramApi = {
  ...
  listCodexModels: (): Promise<CodexModelOption[]> => ipcRenderer.invoke('auth:listCodexModels'),
  setCodexModel: (model: string): Promise<AuthSettings> => ipcRenderer.invoke('auth:setCodexModel', model),
